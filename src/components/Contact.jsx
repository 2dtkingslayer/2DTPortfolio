    ...
    <div name = "contact" className='w-full h-full bg-gradient-to-b from-black to-gray-800 p-4 py-10 text-white'>
        <div className='flex flex-col p-4 mt-6 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action='https://getform.io/f/a8807115-5630-4970-be9c-1fdd7db9e581' method = "POST" className='flex flex-col w-full md:w-1/2'>
                    <input type = "text" name="name" placeholder='Full name' className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
                    ...
                    <button className='text-white bg-gradient-to-b from-sky-400 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>
                        Let's talk
                    </button>
